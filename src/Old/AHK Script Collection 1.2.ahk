...
packtxtreader(pack){																
	...
	loop{
		...
		Send {Home}
		sleep 500
		%pack%%linenumber% = %clipboard%
		if(%pack%%linenumber% = "end"||%pack%%linenumber% = "End"||%pack%%linenumber% = "END"||%pack%%linenumber% = "Break"||%pack%%linenumber% = "BREAK"||%pack%%linenumber% = "break"||%pack%%linenumber% = "stop"||%pack%%linenumber% = "Stop"||%pack%%linenumber% = "STOP"){
...
packlogwriter(prepost,havebeenwillbe,amount,pack,downspeed,downsize,downs,downmin,downh,totdowns,totdownmin,totdownh){	
	run notepad
	sleep 500
	Send %prepost%-Download Log File:{Enter}{Enter}{Enter}The following packs %havebeenwillbe% downloaded:{Enter}{Enter}
	packnumber = 1
	loop %amount%{
		pak := %pack%%packnumber%
...
loop{												; Inputloop
	...
	if(logprompt = "1"){							;log will be created
		packlogwriter("Pre","will be",counter,"Episode",speed,size,downloadspeeds,downloadspeedmin,downloadspeedh,totdownloadspeeds,totdownloadspeedmin,totdownloadspeedh)
...
packlogwriter("Post","have been",counter,"Episode",speed,size,downloadspeeds,downloadspeedmin,downloadspeedh,totdownloadspeeds,totdownloadspeedmin,totdownloadspeedh)
sleep 200
